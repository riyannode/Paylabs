// POST /api/paylabs/agent-capabilities/discovery-ranker
//
// Paid agent capability: rank_active_sources
// Agent 4 of 7 in the nanopayment audit lane.
...
const AGENT_NAME = "discovery_ranker" as const;
...
export async function POST(req: NextRequest) {
  ...
  try {
    const result = { ok: true, capability: "rank_active_sources", agent: AGENT_NAME };
