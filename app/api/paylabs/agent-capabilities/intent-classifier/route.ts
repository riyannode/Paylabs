// POST /api/paylabs/agent-capabilities/intent-classifier
//
// Paid agent capability: classify_intent
// Agent 2 of 7 in the nanopayment audit lane.
...
const AGENT_NAME = "intent_classifier" as const;
...
export async function POST(req: NextRequest) {
  ...
  try {
    const result = { ok: true, capability: "classify_intent", agent: AGENT_NAME };
