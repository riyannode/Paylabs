// POST /api/paylabs/agent-capabilities/provenance-verifier
//
// Paid agent capability: verify_provenance
// Agent 6 of 7 in the nanopayment audit lane.
...
const AGENT_NAME = "provenance_verifier" as const;
...
export async function POST(req: NextRequest) {
  ...
  try {
    const result = { ok: true, capability: "verify_provenance", agent: AGENT_NAME };
