...
- For Easy: explain that the run searches for relevant sources, evaluates them for relevance, and returns the best matches with source links. Mention it runs entry x402 payment for discovery but does not include creator payout phase.
