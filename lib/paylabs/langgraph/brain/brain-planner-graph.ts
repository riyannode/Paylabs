...
- For Easy: 1 sentence. Example: "Entry x402 payment is processed, but this run skips payment-decision and creator payout — it is a straightforward search."
...
tier_decision_reason: "Entry x402 payment is processed, but this run skips payment-decision and creator payout — it is a straightforward AI news search."
...
tier_decision_reason: "Entry x402 payment is processed, but this run skips payment-decision and creator payout — it is a direct knowledge retrieval."
...
tier_decision_reason: "Entry x402 payment is processed, but this run skips payment-decision and creator payout — it is a straightforward crypto news search."
