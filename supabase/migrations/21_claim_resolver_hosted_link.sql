...
-- ─── 1. Update source_platform CHECK for social platforms ───
...
-- ─── 2. Add hosted_link_backlink to proof_method CHECK ────────
...
ALTER TABLE paylabs_creator_claims
  ...
  CHECK (proof_method IN ('well_known_json', 'github_repo_file', 'manual_review', 'hosted_link_backlink', 'platform_profile'));

-- ─── 3. Index for resolver: domain-level verified claims ──────
